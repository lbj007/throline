...
window.I18N = {
  ...
  en: {
    ...
    work_more:"More systems", flagship:"Flagship project", redact:"Real product screenshots; customer data, login identity and revenue figures have been redacted.",
  ...
  zh: {
    ...
    work_more:"更多系统", flagship:"旗舰案例", redact:"以上为真实后台截图，已隐去客户信息、登录账号与营收等敏感数据。",
    appr_title:"怎么和我合作",
  ...
  ja: {
    ...
    work_more:"ほかの仕組みを見る", flagship:"代表事例", redact:"実際の管理画面のスクリーンショットです。顧客情報・ログイン情報・売上などの機微情報は伏せています。",
    appr_title:"わたしとの進め方",
  ...
  ko: {
    ...
    work_more:"더 많은 시스템", flagship:"대표 사례", redact:"실제 백오피스 화면 캡처이며, 고객 정보·로그인 계정·매출 등 민감 정보는 가렸습니다.",
